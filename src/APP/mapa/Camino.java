...
public class Camino {
    ...
    public static Camino crearCamino(List<String> ruta, Mapa metro) {
        ...
        tiempoTotal += (distanciaTotal / (Mapa.VELOCIDAD_METRO*1000/60)) + (ruta.size()-nIntercambios) * 1.5 + nIntercambios*5  ; // Min y medio por parada metro (incluyendo tiempo de frenado y aceleracion)
